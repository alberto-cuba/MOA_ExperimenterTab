...
import moa.experimenter.StatisticalTests.PValuePerTwoAlgorithm;
import moa.experimenter.StatisticalTests.RankPerAlgorithm;
...
public class RankingGraph extends JFrame {
    ...
    public EpsGraphics2D g1 = new EpsGraphics2D();
...
//                }
                ...
                } else if (fileDesc.startsWith("EPS")) {
                     if (fileChooser.getSelectedFile().getName().toUpperCase().endsWith("EPS")==true) {
                      try (Writer out = new FileWriter(fileChooser.getSelectedFile())) {
                                out.write(g1.toString());
                            } catch (IOException ex) {
                                Logger.getLogger(RankingGraph.class.getName()).log(Level.SEVERE, null, ex);
                            }
                            g1 = new EpsGraphics2D();
                            
                    } else {
                       try (Writer out = new FileWriter(new File(fileChooser.getSelectedFile().getAbsolutePath()+".eps"))) {
                                out.write(g1.toString());
                            } catch (IOException ex) {
                                Logger.getLogger(RankingGraph.class.getName()).log(Level.SEVERE, null, ex);
                            }
    ...
    class Graph extends JPanel implements MouseListener,
        ...
        void Graficar(Graphics ap, int xg, int yg) {
            ...
            for (int i = 0; i < algRank.size(); i++) {
                ...
                g1.draw(new Line2D.Double((double) (xdiv * algRank.get(i).rank + xin), yg + ya, (double) (xdiv * algRank.get(i).rank + xin), yg));
                ...
                g1.setStroke(difStroke.getStroke());
                ...
                if (i == 0 && k - 1 != 0) {
                    ...
                    g1.draw(new Line2D.Double((double) (xdiv * algRank.get(i).rank + xin), (yg + ya + yg) / 2, (double) (xdiv * algRank.get(k - 1).rank + xin), (yg + ya + yg) / 2));
                ...
                if (i < algRank.size() / 2) {
                    ...
                    g1.draw(new Line2D.Double((double) (xdiv * algRank.get(i).rank + xin), yg + ya, xfin+3, yg + ya));
                    g1.drawString(algRank.get(i).algName, xfin+3 + 10, yg + ya);
